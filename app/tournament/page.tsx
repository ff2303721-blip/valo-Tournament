              ...
              <section className="relative overflow-hidden rounded-xl border border-[#ff3158]/30 bg-[#0b101b] p-6">
                ...
                <div className="relative">
                  <div className="flex flex-wrap items-end justify-between gap-3">
                    <div>
                      <div className="text-[10px] font-black uppercase tracking-[0.25em] text-[#ff5275]">
                        OFFICIAL PARTNERS
                      </div>
                      ...
                      <p className="mt-1 text-xs text-[#71809a]">
                        Proudly supported by our tournament sponsors.
                      </p>
                    </div>

                    <div className="text-[9px] font-black uppercase tracking-[0.2em] text-[#52e2ff]">
                      XMD FAMILY
                    </div>
                  </div>
