    ...
    <div className="space-y-8">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.3fr_1fr] items-center">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2.5">
              <span className="rounded-full border border-[#0ea5e9]/50 bg-[#0ea5e9]/15 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-[#38bdf8] shadow-[0_0_15px_rgba(14,165,233,0.25)]">
                ⚽ RLCS ARENA SERIES
              </span>
              <span className="rounded-full border border-[#f97316]/50 bg-[#f97316]/15 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-[#fb923c]">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#0ea5e9]/50 bg-[#0ea5e9]/20 px-5 py-2.5 text-xs font-black uppercase tracking-wider text-[#bae6fd] transition hover:bg-[#0ea5e9]/35 hover:shadow-[0_0_20px_rgba(14,165,233,0.3)]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#f97316]/50 bg-[#f97316]/20 px-5 py-2.5 text-xs font-black uppercase tracking-wider text-[#fed7aa] transition hover:bg-[#f97316]/35 hover:shadow-[0_0_20px_rgba(249,115,22,0.3)]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#1e293b] bg-[#0c0a09] px-5 py-2.5 text-xs font-black uppercase tracking-wider text-[#f1f5f9] transition hover:border-[#0ea5e9]/50"
              >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#0ea5e9]/50 bg-gradient-to-b from-[#0c4a6e]/40 via-[#080812] to-[#431407]/40 p-5 shadow-[0_0_35px_rgba(14,165,233,0.2)]">
            <div className="flex items-center justify-between border-b border-[#1e293b] pb-3">
              ...
              <span className="rounded-full border border-[#f97316]/40 bg-[#f97316]/15 px-2.5 py-0.5 text-[9px] font-black uppercase text-[#fb923c]">
                RLCS BOUNTY
              </span>
            </div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-center">
              <div className="rounded-xl border border-[#f59e0b]/50 bg-[#f59e0b]/10 p-3.5 shadow-[0_0_15px_rgba(245,158,11,0.15)]">
                ...
                <span className="block text-[9px] font-black uppercase text-[#fbbf24] mt-1">CHAMPIONS</span>
                <span className="text-sm font-black text-white">₹3,000</span>
                <span className="block text-[8px] font-bold text-[#94a3b8] mt-0.5">Blue/Orange Cup</span>
              </div>
              <div className="rounded-xl border border-[#94a3b8]/40 bg-[#94a3b8]/10 p-3.5">
                ...
                <span className="block text-[8px] font-bold text-[#94a3b8] mt-0.5">Runners Up</span>
              </div>
              <div className="rounded-xl border border-[#0ea5e9]/50 bg-[#0ea5e9]/10 p-3.5">
                <span className="text-2xl">⚡</span>
                <span className="block text-[9px] font-black uppercase text-[#38bdf8] mt-1">STRIKER MVP</span>
                <span className="text-sm font-black text-white">₹1,200</span>
                <span className="block text-[8px] font-bold text-[#94a3b8] mt-0.5">Most Goals</span>
              </div>
            </div>
      ...
      <section className="rounded-2xl border border-[#1e1e3a] bg-[#0c0c18]/85 p-6 backdrop-blur-xl">
        <div className="flex items-center justify-between border-b border-[#1e1e3a] pb-4 mb-5">
          ...
          <span className="rounded-full border border-[#0ea5e9]/30 bg-[#0ea5e9]/10 px-3 py-1 text-[9px] font-black text-[#38bdf8]">
            REGULATION PITCHES
          </span>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          {game.maps.map((arena) => (
            ...
            >
              ...
              <span className="mt-1 inline-block rounded bg-[#1e1e3a] px-2 py-0.5 text-[8px] font-bold text-[#64748b] group-hover:text-[#38bdf8]">
                STANDARD SOCAR
              </span>
            </div>
          ))}
