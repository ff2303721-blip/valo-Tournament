    ...
    <div className="space-y-8">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.3fr_1fr] items-center">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2.5">
              <span className="rounded-full border border-[#f59e0b]/50 bg-[#f59e0b]/15 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-[#fbbf24] shadow-[0_0_15px_rgba(245,158,11,0.25)]">
                🪂 BATTLE ROYALE ESPORTS
              </span>
              <span className="rounded-full border border-[#10b981]/50 bg-[#10b981]/15 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-[#34d399]">
                SAFE ZONE ACTIVE
              </span>
              {settings?.tournamentStatus && (
                <span className="rounded-full border border-[#ef4444]/40 bg-[#ef4444]/10 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-[#f87171]">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-6 text-xs text-[#a8a29e] border-t border-[#292524] pt-5">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#f59e0b]/50 bg-[#f59e0b]/20 px-5 py-2.5 text-xs font-black uppercase tracking-wider text-[#fef08a] transition hover:bg-[#f59e0b]/35 hover:shadow-[0_0_20px_rgba(245,158,11,0.3)]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#10b981]/40 bg-[#10b981]/15 px-5 py-2.5 text-xs font-black uppercase tracking-wider text-[#6ee7b7] transition hover:bg-[#10b981]/25 hover:shadow-[0_0_20px_rgba(16,185,129,0.25)]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-[#292524] bg-[#0c0a09] px-5 py-2.5 text-xs font-black uppercase tracking-wider text-[#f5f5f4] transition hover:border-[#f59e0b]/50"
              >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#f59e0b]/50 bg-gradient-to-b from-[#f59e0b]/15 via-[#1c1917] to-[#0c0a09] p-5 shadow-[0_0_35px_rgba(245,158,11,0.2)]">
            ...
            <div className="flex items-center justify-between border-b border-[#292524] pb-3">
              ...
              <span className="rounded-full border border-[#f59e0b]/40 bg-[#f59e0b]/15 px-2.5 py-0.5 text-[9px] font-black uppercase text-[#fbbf24]">
                AIRDROP BOUNTY
              </span>
            </div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-center">
              <div className="rounded-xl border border-[#f59e0b]/50 bg-[#f59e0b]/10 p-3.5 shadow-[0_0_15px_rgba(245,158,11,0.15)]">
                ...
                <span className="block text-[9px] font-black uppercase text-[#fbbf24] mt-1">WWCD #1</span>
                <span className="text-sm font-black text-white">₹3,000</span>
                <span className="block text-[8px] font-bold text-[#a8a29e] mt-0.5">50% Bounty</span>
              </div>
              <div className="rounded-xl border border-[#94a3b8]/40 bg-[#94a3b8]/10 p-3.5">
                <span className="text-2xl">🥈</span>
                <span className="block text-[9px] font-black uppercase text-[#cbd5e1] mt-1">RUNNER UP</span>
                <span className="text-sm font-black text-white">₹1,800</span>
                <span className="block text-[8px] font-bold text-[#a8a29e] mt-0.5">30% Bounty</span>
              </div>
              <div className="rounded-xl border border-[#ef4444]/40 bg-[#ef4444]/10 p-3.5">
                <span className="text-2xl">🎯</span>
                <span className="block text-[9px] font-black uppercase text-[#f87171] mt-1">TERMINATOR</span>
                <span className="text-sm font-black text-white">₹1,200</span>
                <span className="block text-[8px] font-bold text-[#a8a29e] mt-0.5">Top Finishes</span>
              </div>
            </div>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl border border-[#f59e0b]/30 bg-[#0c0c18]/85 p-6 backdrop-blur-xl">
          ...
          <p className="mt-1 text-xs text-[#78716c]">4-Player Battle Lineups</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#10b981]/30 bg-[#0c0c18]/85 p-6 backdrop-blur-xl">
          ...
          <p className="mt-1 text-xs text-[#78716c]">Match Results Verified</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#ef4444]/30 bg-[#0c0c18]/85 p-6 backdrop-blur-xl">
          ...
          <p className="mt-1 text-xs text-[#78716c]">Active Squads in Combat</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#3b82f6]/30 bg-[#0c0c18]/85 p-6 backdrop-blur-xl">
          ...
          <p className="mt-1 text-xs text-[#78716c]">Erangel, Miramar, Sanhok, Vikendi</p>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded bg-[#1e1e3a] px-2 py-0.5 text-[8px] font-black text-[#a8a29e]">
                    CLASSIC BR
                  </span>
                </div>
      ...
      <section className="overflow-hidden rounded-2xl border border-[#1e1e3a] bg-[#0c0c18]/85 backdrop-blur-xl shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[700px] text-left border-collapse">
            <thead>
              <tr className="border-b border-[#1e1e3a] bg-[#080812] text-[10px] font-black uppercase tracking-[0.2em] text-[#78716c]">
                ...
                return (
                  ...
                  >
                    <td className="px-5 py-4 text-center">
                      {isLeader ? (
                        <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#f59e0b] text-xs font-black text-black shadow-[0_0_15px_rgba(245,158,11,0.5)]">
                          1
                        </span>
                      ) : index === 1 ? (
                        <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#94a3b8] text-xs font-black text-black">
                          2
                        </span>
                      ) : index === 2 ? (
                        <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#b45309] text-xs font-black text-white">
                          3
                        </span>
                      ) : (
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        {row.team.logo ? (
                          ...
                          <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-[#f59e0b]/30 bg-[#f59e0b]/10 text-xs font-black text-[#fbbf24]">
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="rounded bg-[#1e1e3a] px-1.5 py-0.2 text-[9px] font-bold text-[#a8a29e]">
                              [{row.team.tag}]
                            </span>
                          </div>
